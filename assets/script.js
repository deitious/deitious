...
const photoPaths = [
  'assets/photos/IMG-20251202-WA0015.jpg',
  'assets/photos/IMG-20251202-WA0020.jpg',
  'assets/photos/IMG-20251202-WA0021.jpg',
  'assets/photos/IMG-20251220-WA0001.jpg'
  // add all other photos
];
photoPaths.forEach(p=>{
  let img = document.createElement('img');
  img.src = p;
  img.alt = "Kababy Photo 💖";
...
const songPaths = [
  'assets/music/B_Young_-_R_Drill__Official_Video_(48k).mp3',
  'assets/music/Justin Timberlake - Mirrors _Official Music Video_.mp3',
  'assets/music/Shayne Ward - Breathless (Video).mp3'
  // add all other songs
];
songPaths.forEach(s=>{
